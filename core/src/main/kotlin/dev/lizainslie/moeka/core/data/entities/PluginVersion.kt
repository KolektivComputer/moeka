...
class PluginVersion(id: EntityID<String>) : Entity<String>(id) {
    var pluginName by PluginVersionTable.id
    private var _version by PluginVersionTable.version
    ...
    companion object : EntityClass<String, PluginVersion>(PluginVersionTable) {
        fun upsert(moduleName: String, version: Version): PluginVersion {
