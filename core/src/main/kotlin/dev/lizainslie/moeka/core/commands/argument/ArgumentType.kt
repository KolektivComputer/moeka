...
interface ArgumentType<T : Any> {
    ...
    fun tryParse(
        ...
        log.info(
            "Parsing value: `$value` on platform ${platform.key} of value type ${value::class.simpleName} for ArgumentType.${this::class.simpleName}",
        )
    ...
    fun preValidate(value: Any) = preValidator?.validate(value) ?: ValidationResult.Valid
